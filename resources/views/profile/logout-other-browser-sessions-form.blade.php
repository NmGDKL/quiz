<x-jet-action-section>
    ...
    <x-slot name="description">
        Oturum açılan tarayıcıları görüntüleyin ve yönetin
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('İsterseniz diğer tarayıcılarda açılmış olan tüm oturumları kapatabilirsiniz.') }}
        </div>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @if ($session->is_current_device)
                                        <span class="text-green-500 font-semibold">Bu Cihaz</span>
                                    @else
...
Başarılı            </x-jet-action-message>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
Lütfen diğer oturumları kapatmak için hesap şifrenizi giriniz.
